...
pub struct uhash_ctx {
    pub hash: nh_ctx,
    pub poly_key_8: [UINT64; 4],
    pub poly_accum: [UINT64; 4],
    pub ip_keys: [UINT64; 16],
    pub ip_trans: [UINT32; 4],
    pub msg_len: UINT32,
}
...
pub unsafe extern "C" fn umac128_new(mut key: *const u_char) -> *mut umac128_ctx {
    let mut ctx: *mut umac128_ctx = 0 as *mut umac128_ctx;
    let mut octx: *mut umac128_ctx = 0 as *mut umac128_ctx;
    ...
    if !ctx.is_null() {
        bytes_to_add = (16 as libc::c_int as libc::c_long
            ...
            as size_t;
        ctx = (ctx as *mut u_char).offset(bytes_to_add as isize) as *mut umac128_ctx;
...
unsafe extern "C" fn uhash_init(mut ahc: uhash_ctx_t, mut prf_key: *mut AES_KEY) {
    ...
    kdf(
        ...
        ::core::mem::size_of::<[UINT8; 288]>() as libc::c_ulong as libc::c_int,
    );
    i = 0 as libc::c_int;
    ...
    endian_convert(
        ...
        ::core::mem::size_of::<[UINT64; 16]>() as libc::c_ulong as UINT32,
    );
    i = 0 as libc::c_int;
    while i < 16 as libc::c_int / 4 as libc::c_int * 4 as libc::c_int {
    ...
    explicit_bzero(
        buf.as_mut_ptr() as *mut libc::c_void,
        ::core::mem::size_of::<[UINT8; 288]>() as libc::c_ulong,
    );
}
...
unsafe extern "C" fn nh_init(mut hc: *mut nh_ctx, mut prf_key: *mut AES_KEY) {
    kdf(
        ...
        ::core::mem::size_of::<[UINT8; 1072]>() as libc::c_ulong as libc::c_int,
    );
    endian_convert(
        ((*hc).nh_key).as_mut_ptr() as *mut libc::c_void,
        4 as libc::c_int as UWORD,
        ::core::mem::size_of::<[UINT8; 1072]>() as libc::c_ulong as UINT32,
    );
    nh_reset(hc);
}
unsafe extern "C" fn nh_reset(mut hc: *mut nh_ctx) {
    ...
    (*hc).state[2 as libc::c_int as usize] = 0 as libc::c_int as UINT64;
    (*hc).state[3 as libc::c_int as usize] = 0 as libc::c_int as UINT64;
}
...
pub unsafe extern "C" fn umac128_update(
...
unsafe extern "C" fn uhash_update(
    ...
    let mut result_buf: [UINT64; 4] = [0; 4];
    let mut nh_result: *mut UINT8 = &mut result_buf as *mut [UINT64; 4] as *mut UINT8;
...
unsafe extern "C" fn nh_aux(
    ...
    let mut k12: UINT32 = 0;
    let mut k13: UINT32 = 0;
    let mut k14: UINT32 = 0;
    let mut k15: UINT32 = 0;
    let mut k16: UINT32 = 0;
    let mut k17: UINT32 = 0;
    let mut k18: UINT32 = 0;
    let mut k19: UINT32 = 0;
    h1 = *(hp as *mut UINT64);
    h2 = *(hp as *mut UINT64).offset(1 as libc::c_int as isize);
    h3 = *(hp as *mut UINT64).offset(2 as libc::c_int as isize);
    h4 = *(hp as *mut UINT64).offset(3 as libc::c_int as isize);
    ...
    loop {
        ...
        k12 = *k.offset(12 as libc::c_int as isize);
        k13 = *k.offset(13 as libc::c_int as isize);
        k14 = *k.offset(14 as libc::c_int as isize);
        k15 = *k.offset(15 as libc::c_int as isize);
        k16 = *k.offset(16 as libc::c_int as isize);
        k17 = *k.offset(17 as libc::c_int as isize);
        k18 = *k.offset(18 as libc::c_int as isize);
        k19 = *k.offset(19 as libc::c_int as isize);
        ...
        h3 = (h3 as libc::c_ulong).wrapping_add(
            (k8.wrapping_add(d0) as UINT64).wrapping_mul(k12.wrapping_add(d4) as UINT64),
        ) as UINT64 as UINT64;
        h4 = (h4 as libc::c_ulong).wrapping_add(
            (k12.wrapping_add(d0) as UINT64).wrapping_mul(k16.wrapping_add(d4) as UINT64),
        ) as UINT64 as UINT64;
        h1 = (h1 as libc::c_ulong).wrapping_add(
        ...
        h3 = (h3 as libc::c_ulong).wrapping_add(
            (k9.wrapping_add(d1) as UINT64).wrapping_mul(k13.wrapping_add(d5) as UINT64),
        ) as UINT64 as UINT64;
        h4 = (h4 as libc::c_ulong).wrapping_add(
            (k13.wrapping_add(d1) as UINT64).wrapping_mul(k17.wrapping_add(d5) as UINT64),
        ) as UINT64 as UINT64;
        h1 = (h1 as libc::c_ulong).wrapping_add(
        ...
        h3 = (h3 as libc::c_ulong).wrapping_add(
            (k10.wrapping_add(d2) as UINT64).wrapping_mul(k14.wrapping_add(d6) as UINT64),
        ) as UINT64 as UINT64;
        h4 = (h4 as libc::c_ulong).wrapping_add(
            (k14.wrapping_add(d2) as UINT64).wrapping_mul(k18.wrapping_add(d6) as UINT64),
        ) as UINT64 as UINT64;
        h1 = (h1 as libc::c_ulong).wrapping_add(
        ...
        h3 = (h3 as libc::c_ulong).wrapping_add(
            (k11.wrapping_add(d3) as UINT64).wrapping_mul(k15.wrapping_add(d7) as UINT64),
        ) as UINT64 as UINT64;
        h4 = (h4 as libc::c_ulong).wrapping_add(
            (k15.wrapping_add(d3) as UINT64).wrapping_mul(k19.wrapping_add(d7) as UINT64),
        ) as UINT64 as UINT64;
        k0 = k8;
        k1 = k9;
        k2 = k10;
    ...
    *(hp as *mut UINT64).offset(2 as libc::c_int as isize) = h3;
    *(hp as *mut UINT64).offset(3 as libc::c_int as isize) = h4;
}
...
unsafe extern "C" fn nh(
    ...
    *(result as *mut UINT64).offset(2 as libc::c_int as isize) = nbits as UINT64;
    *(result as *mut UINT64).offset(3 as libc::c_int as isize) = nbits as UINT64;
    nh_aux(
        ((*hc).nh_key).as_mut_ptr() as *mut libc::c_void,
        buf as *const libc::c_void,
...
unsafe extern "C" fn nh_final(mut hc: *mut nh_ctx, mut result: *mut UINT8) {
    ...
    *(result as *mut UINT64).offset(1 as libc::c_int as isize) =
        (*((*hc).state).as_mut_ptr().offset(1 as libc::c_int as isize))
            .wrapping_add(nbits as libc::c_ulong);
    *(result as *mut UINT64).offset(2 as libc::c_int as isize) =
        (*((*hc).state).as_mut_ptr().offset(2 as libc::c_int as isize))
            .wrapping_add(nbits as libc::c_ulong);
    *(result as *mut UINT64).offset(3 as libc::c_int as isize) =
        (*((*hc).state).as_mut_ptr().offset(3 as libc::c_int as isize))
            .wrapping_add(nbits as libc::c_ulong);
    nh_reset(hc);
}
...
pub unsafe extern "C" fn umac128_final(
    mut ctx: *mut umac128_ctx,
    mut tag: *mut u_char,
...
unsafe extern "C" fn pdf_gen_xor(
    ...
    *((t.tmp_nonce_lo).as_mut_ptr() as *mut UINT32) =
    ...
    t.tmp_nonce_lo[3 as libc::c_int as usize] =
        (t.tmp_nonce_lo[3 as libc::c_int as usize] as libc::c_int & !(0 as libc::c_int)) as UINT8;
    ...
    let ref mut fresh0 = *(buf as *mut UINT64).offset(0 as libc::c_int as isize);
    *fresh0 ^= *(((*pc).cache).as_mut_ptr() as *mut UINT64).offset(0 as libc::c_int as isize);
    let ref mut fresh1 = *(buf as *mut UINT64).offset(1 as libc::c_int as isize);
    *fresh1 ^= *(((*pc).cache).as_mut_ptr() as *mut UINT64).offset(1 as libc::c_int as isize);
}
...
unsafe extern "C" fn uhash_reset(mut pc: uhash_ctx_t) -> libc::c_int {
    ...
    (*pc).poly_accum[2 as libc::c_int as usize] = 1 as libc::c_int as UINT64;
    (*pc).poly_accum[3 as libc::c_int as usize] = 1 as libc::c_int as UINT64;
    return 1 as libc::c_int;
}
unsafe extern "C" fn ip_short(mut ahc: uhash_ctx_t, mut nh_res: *mut UINT8, mut res: *mut u_char) {
    ...
    t = ip_aux(
        ...
        *nhp.offset(2 as libc::c_int as isize),
    );
    put_u32(
        (res as *mut UINT32).offset(2 as libc::c_int as isize) as *mut libc::c_void,
        ip_reduce_p36(t) ^ (*ahc).ip_trans[2 as libc::c_int as usize],
    );
    t = ip_aux(
        0 as libc::c_int as UINT64,
        ((*ahc).ip_keys)
        ...
        *nhp.offset(3 as libc::c_int as isize),
    );
    put_u32(
        (res as *mut UINT32).offset(3 as libc::c_int as isize) as *mut libc::c_void,
        ip_reduce_p36(t) ^ (*ahc).ip_trans[3 as libc::c_int as usize],
    );
}
...
pub unsafe extern "C" fn umac128_delete(mut ctx: *mut umac128_ctx) -> libc::c_int {
    if !ctx.is_null() {
        ctx = (*ctx).free_ptr as *mut umac128_ctx;
        freezero(
...
pub static mut umac128_ctx: umac128_ctx = umac128_ctx {
    hash: uhash_ctx {
        hash: nh_ctx {
            nh_key: [0; 1072],
            data: [0; 64],
