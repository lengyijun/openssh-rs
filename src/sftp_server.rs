...
unsafe extern "C" fn get_handle(
    ...
    *hp = -(1 as libc::c_int);
    r = crate::sshbuf_getput_basic::sshbuf_get_string(queue, &mut handle, &mut hlen);
...
unsafe extern "C" fn send_status_errmsg(
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u32(msg, status);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
unsafe extern "C" fn send_names(mut id: u_int32_t, mut count: libc::c_int, mut stats: *const Stat) {
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u32(msg, count as u_int32_t);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
    ...
    i = 0 as libc::c_int;
    while i < count {
        r = crate::sshbuf_getput_basic::sshbuf_put_cstring(msg, (*stats.offset(i as isize)).name);
        if r != 0 as libc::c_int
            || {
                r = crate::sshbuf_getput_basic::sshbuf_put_cstring(
                    msg,
                    (*stats.offset(i as isize)).long_name,
                );
                r != 0 as libc::c_int
            }
            || {
...
unsafe extern "C" fn send_statvfs(mut id: u_int32_t, mut st: *mut statvfs) {
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_bsize);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_frsize);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_blocks);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_bfree);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_bavail);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_files);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_ffree);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_favail);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_fsid);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, flag);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, (*st).f_namemax);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
unsafe extern "C" fn compose_extension(
    ...
    if r != 0 as libc::c_int || {
        r = crate::sshbuf_getput_basic::sshbuf_put_cstring(msg, ver);
        r != 0 as libc::c_int
    } {
        sshfatal(
            b"sftp-server.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn process_init() {
    let mut msg: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    let mut r: libc::c_int = 0;
    r = crate::sshbuf_getput_basic::sshbuf_get_u32(iqueue, &mut version);
    if r != 0 as libc::c_int {
        sshfatal(
            b"sftp-server.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn process_open(mut id: u_int32_t) {
    ...
    r = crate::sshbuf_getput_basic::sshbuf_get_cstring(iqueue, &mut name, 0 as *mut size_t);
    if r != 0 as libc::c_int
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u32(iqueue, &mut pflags);
            r != 0 as libc::c_int
        }
        || {
...
unsafe extern "C" fn process_read(mut id: u_int32_t) {
    ...
    if r != 0 as libc::c_int
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u64(iqueue, &mut off);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u32(iqueue, &mut len);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
unsafe extern "C" fn process_write(mut id: u_int32_t) {
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_string(iqueue, &mut data, &mut len);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
unsafe extern "C" fn process_opendir(mut id: u_int32_t) {
    ...
    let mut handle: libc::c_int = 0;
    let mut status: libc::c_int = 4 as libc::c_int;
    r = crate::sshbuf_getput_basic::sshbuf_get_cstring(iqueue, &mut path, 0 as *mut size_t);
    if r != 0 as libc::c_int {
        sshfatal(
            b"sftp-server.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn process_rename(mut id: u_int32_t) {
    ...
    r = crate::sshbuf_getput_basic::sshbuf_get_cstring(iqueue, &mut oldpath, 0 as *mut size_t);
    if r != 0 as libc::c_int || {
        r = crate::sshbuf_getput_basic::sshbuf_get_cstring(iqueue, &mut newpath, 0 as *mut size_t);
        r != 0 as libc::c_int
    } {
        sshfatal(
            b"sftp-server.c\0" as *const u8 as *const libc::c_char,
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(
                msg,
                (256 as libc::c_int * 1024 as libc::c_int) as u_int64_t,
            );
            r != 0 as libc::c_int
        }
        || {
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u64(msg, nfiles);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
unsafe extern "C" fn process_extended_copy_data(mut id: u_int32_t) {
    ...
    if r != 0 as libc::c_int
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u64(iqueue, &mut read_off);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u64(iqueue, &mut read_len);
            r != 0 as libc::c_int
        }
        || {
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u64(iqueue, &mut write_off);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
unsafe extern "C" fn process_extended_home_directory(mut id: u_int32_t) {
    ...
    r = crate::sshbuf_getput_basic::sshbuf_get_cstring(iqueue, &mut username, 0 as *mut size_t);
    if r != 0 as libc::c_int {
        sshfatal(
            b"sftp-server.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn process_extended_get_users_groups_by_id(mut id: u_int32_t) {
    ...
    while crate::sshbuf::sshbuf_len(uids) != 0 as libc::c_int as libc::c_ulong {
        r = crate::sshbuf_getput_basic::sshbuf_get_u32(uids, &mut n);
        if r != 0 as libc::c_int {
            sshfatal(
                b"sftp-server.c\0" as *const u8 as *const libc::c_char,
                (*::core::mem::transmute::<&[u8; 40], &[libc::c_char; 40]>(
        ...
        r = crate::sshbuf_getput_basic::sshbuf_put_cstring(usernames, name);
        if r != 0 as libc::c_int {
            sshfatal(
                b"sftp-server.c\0" as *const u8 as *const libc::c_char,
                (*::core::mem::transmute::<&[u8; 40], &[libc::c_char; 40]>(
    ...
    while crate::sshbuf::sshbuf_len(gids) != 0 as libc::c_int as libc::c_ulong {
        r = crate::sshbuf_getput_basic::sshbuf_get_u32(gids, &mut n);
        if r != 0 as libc::c_int {
            sshfatal(
                b"sftp-server.c\0" as *const u8 as *const libc::c_char,
                (*::core::mem::transmute::<&[u8; 40], &[libc::c_char; 40]>(
        ...
        r = crate::sshbuf_getput_basic::sshbuf_put_cstring(groupnames, name);
        if r != 0 as libc::c_int {
            sshfatal(
                b"sftp-server.c\0" as *const u8 as *const libc::c_char,
                (*::core::mem::transmute::<&[u8; 40], &[libc::c_char; 40]>(
...
unsafe extern "C" fn process_extended(mut id: u_int32_t) {
    ...
    r = crate::sshbuf_getput_basic::sshbuf_get_cstring(iqueue, &mut request, 0 as *mut size_t);
    if r != 0 as libc::c_int {
        sshfatal(
            b"sftp-server.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn process() {
    ...
    match type_0 as libc::c_int {
        ...
        200 => {
            ...
            r = crate::sshbuf_getput_basic::sshbuf_get_u32(iqueue, &mut id);
            if r != 0 as libc::c_int {
                sshfatal(
                    b"sftp-server.c\0" as *const u8 as *const libc::c_char,
                    (*::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"process\0"))
