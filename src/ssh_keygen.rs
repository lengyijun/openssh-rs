...
extern "C" {
    ...
    fn sshkey_fromb(_: *mut sshbuf, _: *mut *mut sshkey) -> libc::c_int;
    ...
    fn ssh_rsa_complete_crt_parameters(_: *mut sshkey, _: *const BIGNUM) -> libc::c_int;
    ...
    fn sshbuf_dtob16(buf: *mut sshbuf) -> *mut libc::c_char;
    fn sshbuf_dtob64_string(buf: *const sshbuf, wrap: libc::c_int) -> *mut libc::c_char;
    fn sshbuf_b64tod(buf: *mut sshbuf, b64: *const libc::c_char) -> libc::c_int;
    ...
    fn ssh_krl_revoke_key_explicit(krl: *mut ssh_krl, key: *const sshkey) -> libc::c_int;
    ...
    fn ssh_krl_revoke_key(krl: *mut ssh_krl, key: *const sshkey) -> libc::c_int;
    fn ssh_krl_to_blob(
        krl: *mut ssh_krl,
        buf: *mut sshbuf,
        sign_keys: *mut *mut sshkey,
        nsign_keys: u_int,
    ) -> libc::c_int;
    fn ssh_krl_from_blob(
        buf: *mut sshbuf,
        krlp: *mut *mut ssh_krl,
        sign_ca_keys: *mut *const sshkey,
    ...
    fn ssh_agent_has_key(sock: libc::c_int, key: *const sshkey) -> libc::c_int;
    fn ssh_agent_sign(
        sock: libc::c_int,
        key: *const sshkey,
        sigp: *mut *mut u_char,
    ...
    fn sshsig_verify_fd(
        signature: *mut sshbuf,
        fd: libc::c_int,
        sig_namespace: *const libc::c_char,
        sign_keyp: *mut *mut sshkey,
        sig_details: *mut *mut sshkey_sig_details,
    ) -> libc::c_int;
    fn sshsig_armor(blob: *const sshbuf, out: *mut *mut sshbuf) -> libc::c_int;
    fn sshsig_dearmor(sig: *mut sshbuf, out: *mut *mut sshbuf) -> libc::c_int;
    fn sshsig_check_allowed_keys(
        path: *const libc::c_char,
        sign_key: *const sshkey,
        principal: *const libc::c_char,
        ns: *const libc::c_char,
        verify_time: uint64_t,
    ) -> libc::c_int;
    fn sshsig_get_pubkey(signature: *mut sshbuf, pubkey: *mut *mut sshkey) -> libc::c_int;
        ...
        1 => {
            if *bitsp != 1024 as libc::c_int as libc::c_uint {
                sshfatal(
                    ...
                    SYSLOG_LEVEL_FATAL,
                    0 as *const libc::c_char,
                    b"Invalid DSA key length: must be 1024 bits\0" as *const u8
        ...
        0 => {
            if *bitsp < 1024 as libc::c_int as libc::c_uint {
                sshfatal(
                    ...
                    SYSLOG_LEVEL_FATAL,
                    0 as *const libc::c_char,
                    b"Invalid RSA key length: minimum is %d bits\0" as *const u8
                        as *const libc::c_char,
                    1024 as libc::c_int,
                );
                ...
                sshfatal(
                    ...
                    SYSLOG_LEVEL_FATAL,
                    0 as *const libc::c_char,
                    b"Invalid RSA key length: maximum is %d bits\0" as *const u8
                        as *const libc::c_char,
                    16384 as libc::c_int,
                );
            }
...
unsafe extern "C" fn ask_filename(mut pw: *mut passwd, mut prompt: *const libc::c_char) {
...
unsafe extern "C" fn do_convert_to_ssh2(mut pw: *mut passwd, mut k: *mut sshkey) {
...
unsafe extern "C" fn do_convert_private_ssh2(mut b: *mut sshbuf) -> *mut sshkey {
        ...
        0 => {
                ...
                }
            {
                sshfatal(
                    ...
                    SYSLOG_LEVEL_FATAL,
                    ssh_err(r),
                    b"parse RSA\0" as *const u8 as *const libc::c_char,
                );
            }
            e = e1 as u_long;
            crate::log::sshlog(
            ...
            if r != 0 as libc::c_int {
                sshfatal(
                    ...
                    SYSLOG_LEVEL_FATAL,
                    ssh_err(r),
                    b"generate RSA parameters\0" as *const u8 as *const libc::c_char,
                );
            }
...
unsafe extern "C" fn do_convert_from(mut pw: *mut passwd) {
    let mut k: *mut sshkey = 0 as *mut sshkey;
    let mut r: libc::c_int = 0;
...
unsafe extern "C" fn do_download(mut _pw: *mut passwd) {
    ...
    while i < nkeys {
        if print_fingerprint != 0 {
            fp = sshkey_fingerprint(*keys.offset(i as isize), fptype, rep);
            ra = sshkey_fingerprint(*keys.offset(i as isize), fingerprint_hash, SSH_FP_RANDOMART);
            ...
            printf(
                ...
                fp,
                sshkey_type(*keys.offset(i as isize)),
            );
...
unsafe extern "C" fn do_gen_all_hostkeys(mut pw: *mut passwd) {
    ...
    let mut key_types: [C2RustUnnamed_1; 4] = [
        {
            let mut init = C2RustUnnamed_1 {
                ...
                key_type_display: b"RSA\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ...
    while !(key_types[i as usize].key_type).is_null() {
        ...
        sshkey_free(private);
        sshkey_free(public);
        free(prv_tmp as *mut libc::c_void);
        free(pub_tmp as *mut libc::c_void);
        free(prv_file as *mut libc::c_void);
        free(pub_file as *mut libc::c_void);
        i += 1;
        i;
    }
    if first != 0 as libc::c_int {
...
unsafe extern "C" fn do_change_passphrase(mut pw: *mut passwd) {
    ...
    if !identity_new_passphrase.is_null() {
        ...
        if strcmp(passphrase1, passphrase2) != 0 as libc::c_int {
            ...
            free(passphrase1 as *mut libc::c_void);
            free(passphrase2 as *mut libc::c_void);
            printf(
...
unsafe extern "C" fn do_change_comment(
    ...
    if !comment.is_null() && strcmp(comment, new_comment.as_mut_ptr()) == 0 as libc::c_int {
        ...
        free(passphrase as *mut libc::c_void);
        sshkey_free(private);
        free(comment as *mut libc::c_void);
        exit(0 as libc::c_int);
    }
...
unsafe extern "C" fn prepare_options_buf(mut c: *mut sshbuf, mut which: libc::c_int) {
    let mut b: *mut sshbuf = 0 as *mut sshbuf;
    let mut i: size_t = 0;
    let mut r: libc::c_int = 0;
...
unsafe extern "C" fn load_pkcs11_key(mut path: *mut libc::c_char) -> *mut sshkey {
    let mut keys: *mut *mut sshkey = 0 as *mut *mut sshkey;
    let mut public: *mut sshkey = 0 as *mut sshkey;
    let mut private: *mut sshkey = 0 as *mut sshkey;
    let mut r: libc::c_int = 0;
...
unsafe extern "C" fn show_options(mut optbuf: *mut sshbuf, mut in_critical: libc::c_int) {
    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut arg: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut hex: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut options: *mut sshbuf = 0 as *mut sshbuf;
    let mut option: *mut sshbuf = 0 as *mut sshbuf;
    let mut r: libc::c_int = 0;
...
unsafe extern "C" fn do_gen_krl(
    ...
    if ssh_krl_to_blob(krl, kbuf, 0 as *mut *mut sshkey, 0 as libc::c_int as u_int)
        != 0 as libc::c_int
    {
        sshfatal(
            b"ssh-keygen.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn load_sign_key(
    ...
    if sshkey_equal_public(pubkey, privkey) == 0 {
        ...
        match current_block {
            ...
            _ => {
                ret = privkey;
                privkey = 0 as *mut sshkey;
            }
        }
    }
    sshkey_free(privkey);
    free(privpath as *mut libc::c_void);
    return ret;
}
unsafe extern "C" fn sign_one(
    mut signkey: *mut sshkey,
    mut filename: *const libc::c_char,
    mut fd: libc::c_int,
    ...
    if signer.is_none() && sshkey_is_sk(signkey) != 0 {
        ...
        if (*signkey).sk_flags as libc::c_int & 0x1 as libc::c_int != 0 {
            fp = sshkey_fingerprint(signkey, fingerprint_hash, SSH_FP_DEFAULT);
            if fp.is_null() {
                sshfatal(
                    b"ssh-keygen.c\0" as *const u8 as *const libc::c_char,
                    (*::core::mem::transmute::<&[u8; 9], &[libc::c_char; 9]>(b"sign_one\0"))
    ...
    free(wfile as *mut libc::c_void);
    free(prompt as *mut libc::c_void);
    free(asig as *mut libc::c_void);
    if !pin.is_null() {
        freezero(pin as *mut libc::c_void, strlen(pin));
    }
    sshbuf_free(abuf);
...
unsafe extern "C" fn sig_sign(
    ...
    let mut pubkey: *mut sshkey = 0 as *mut sshkey;
    let mut privkey: *mut sshkey = 0 as *mut sshkey;
    let mut signkey: *mut sshkey = 0 as *mut sshkey;
...
unsafe extern "C" fn sig_verify(
    ...
    let mut sigbuf: *mut sshbuf = 0 as *mut sshbuf;
    let mut abuf: *mut sshbuf = 0 as *mut sshbuf;
    let mut sign_key: *mut sshkey = 0 as *mut sshkey;
    let mut fp: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    ) != 0 as libc::c_int)
    {
        ...
        if r != 0 as libc::c_int {
            ...
            if r != 0 as libc::c_int {
                ...
                if !(r != 0 as libc::c_int) {
                    fp = sshkey_fingerprint(sign_key, fingerprint_hash, SSH_FP_DEFAULT);
                    if fp.is_null() {
                        sshfatal(
                            b"ssh-keygen.c\0" as *const u8 as *const libc::c_char,
                            (*::core::mem::transmute::<&[u8; 11], &[libc::c_char; 11]>(
...
unsafe extern "C" fn do_moduli_screen(
    ...
    while i < nopts {
        ...
        {
            free(checkpoint as *mut libc::c_void);
            ...
            if confirm_overwrite(path) == 0 {
                ...
                if r != 0 as libc::c_int {
                    ...
                    if r != 0 as libc::c_int {
                        ...
                        free(pubpath as *mut libc::c_void);
                        break;
                    } else {
                        free(pubpath as *mut libc::c_void);
                    }
...
unsafe extern "C" fn save_attestation(mut attest: *mut sshbuf, mut path: *const libc::c_char) {
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    if quiet == 0 {
        fp = sshkey_fingerprint(public, fingerprint_hash, SSH_FP_DEFAULT);
        ra = sshkey_fingerprint(public, fingerprint_hash, SSH_FP_RANDOMART);
        if fp.is_null() || ra.is_null() {
            sshfatal(
                b"ssh-keygen.c\0" as *const u8 as *const libc::c_char,
