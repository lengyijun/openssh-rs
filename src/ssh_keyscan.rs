...
extern "C" {
    ...
    fn ssh_set_verify_host_key_callback(
        ssh: *mut ssh,
        cb: Option<unsafe extern "C" fn(*mut sshkey, *mut ssh) -> libc::c_int>,
    ) -> libc::c_int;
    fn export_dns_rr(
        _: *const libc::c_char,
        _: *mut sshkey,
...
unsafe extern "C" fn key_print_wrapper(mut hostkey: *mut sshkey, mut ssh: *mut ssh) -> libc::c_int {
...
unsafe extern "C" fn keygrab_ssh2(mut c: *mut con) {
    ...
    ssh_set_verify_host_key_callback(
        (*c).c_ssh,
        Some(key_print_wrapper as unsafe extern "C" fn(*mut sshkey, *mut ssh) -> libc::c_int),
    );
    ssh_dispatch_run(
        (*c).c_ssh,
...
unsafe extern "C" fn keyprint_one(mut host: *const libc::c_char, mut key: *mut sshkey) {
