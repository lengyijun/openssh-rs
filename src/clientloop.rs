...
extern "C" {
    ...
    fn hostfile_replace_entries(
        ...
        keys: *mut *mut crate::sshkey::sshkey,
        nkeys: size_t,
...
pub struct hostkeys_update_ctx {
    ...
    pub old_keys: *mut *mut crate::sshkey::sshkey,
    pub nold: size_t,
        ...
        if (*efc).escape_pending != 0 {
            ...
            match ch as libc::c_int {
                ...
                66 => {
                    ...
                    r = crate::packet::sshpkt_put_u32(ssh, 1000 as libc::c_int as u_int32_t);
                    if r != 0 as libc::c_int || {
                        r = crate::packet::sshpkt_send(ssh);
                        r != 0 as libc::c_int
                    } {
...
pub unsafe extern "C" fn client_loop(
    ...
    r = crate::packet::sshpkt_start(ssh, 1 as libc::c_int as u_char);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_put_u32(ssh, 11 as libc::c_int as u_int32_t);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_put_cstring(
...
unsafe extern "C" fn client_request_forwarded_tcpip(
    ...
    let mut r: libc::c_int = 0;
    r = crate::packet::sshpkt_get_cstring(ssh, &mut listen_address, 0 as *mut size_t);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_get_u32(ssh, &mut listen_port);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_get_cstring(ssh, &mut originator_address, 0 as *mut size_t);
            r != 0 as libc::c_int
        }
        || {
...
unsafe extern "C" fn client_request_forwarded_streamlocal(
    ...
    let mut r: libc::c_int = 0;
    r = crate::packet::sshpkt_get_cstring(ssh, &mut listen_path, 0 as *mut size_t);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_get_string(ssh, 0 as *mut *mut u_char, 0 as *mut size_t);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_get_end(ssh);
...
unsafe extern "C" fn client_request_x11(
    ...
    r = crate::packet::sshpkt_get_cstring(ssh, &mut originator, 0 as *mut size_t);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_get_u32(ssh, &mut originator_port);
            r != 0 as libc::c_int
...
pub unsafe extern "C" fn client_request_tun_fwd(
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::packet::sshpkt_put_u32(ssh, (*c).local_window_max);
            r != 0 as libc::c_int
        }
        || {
        ...
        || {
            r = crate::packet::sshpkt_put_u32(ssh, tun_mode as u_int32_t);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_put_u32(ssh, remote_tun as u_int32_t);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_send(ssh);
...
unsafe extern "C" fn client_input_channel_open(
    ...
    r = crate::packet::sshpkt_get_cstring(ssh, &mut ctype, &mut len);
    if !(r != 0 as libc::c_int
        || {
...
unsafe extern "C" fn client_input_channel_req(
    ...
    if !(r != 0 as libc::c_int || {
        r = crate::packet::sshpkt_get_u8(ssh, &mut reply);
        r != 0 as libc::c_int
    }) {
        crate::log::sshlog(
            b"clientloop.c\0" as *const u8 as *const libc::c_char,
        ...
        {
            r = crate::packet::sshpkt_get_u32(ssh, &mut exitval);
            if r != 0 as libc::c_int {
                current_block = 17569473009162609004;
            } else {
                if (*c).ctl_chan != -(1 as libc::c_int) {
...
unsafe extern "C" fn hostkeys_find(
    ...
    *fresh2 = (*l).key;
    (*l).key = 0 as *mut crate::sshkey::sshkey;
    return 0 as libc::c_int;
}
            ...
            if r != 0 as libc::c_int {
                    ...
                    ) != 1 as libc::c_int
                {
                    crate::log::sshlog(
                        ...
                        SYSLOG_LEVEL_DEBUG1,
                        0 as *const libc::c_char,
                        b"server used untrusted crate::sshkey::RSA signature algorithm %s for key %zu, disregarding\0"
                            as *const u8 as *const libc::c_char,
                        alg,
                        i,
                    );
...
unsafe extern "C" fn key_accepted_by_hostkeyalgs(
...
unsafe extern "C" fn client_send_env(
    ...
    r = crate::packet::sshpkt_put_cstring(ssh, name as *const libc::c_void);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_put_cstring(ssh, val as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_send(ssh);
