...
unsafe extern "C" fn close_socket(mut e: *mut SocketEntry) {
    ...
    while i < (*e).nsession_ids {
        crate::sshkey::sshkey_free((*((*e).session_ids).offset(i as isize)).key);
...
unsafe extern "C" fn free_dest_constraint_hop(mut dch: *mut dest_constraint_hop) {
    ...
    while i < (*dch).nkeys {
        crate::sshkey::sshkey_free(*((*dch).keys).offset(i as isize));
        i = i.wrapping_add(1);
        i;
    }
...
unsafe extern "C" fn permitted_by_dest_constraints(
    mut fromkey: *const crate::sshkey::sshkey,
    mut tokey: *const crate::sshkey::sshkey,
    mut id: *mut Identity,
...
unsafe extern "C" fn identity_permitted(
    ...
    let mut fromkey: *const crate::sshkey::sshkey = 0 as *const crate::sshkey::sshkey;
...
unsafe extern "C" fn lookup_identity(mut key: *mut crate::sshkey::sshkey) -> *mut Identity {
...
unsafe extern "C" fn send_status(mut e: *mut SocketEntry, mut success: libc::c_int) {
    ...
    r = crate::sshbuf_getput_basic::sshbuf_put_u32((*e).output, 1 as libc::c_int as u_int32_t);
...
unsafe extern "C" fn process_request_identities(mut e: *mut SocketEntry) {
    ...
    if r != 0 as libc::c_int
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u32(msg, nentries);
            r != 0 as libc::c_int
        }
        || {
...
unsafe extern "C" fn agent_decode_alg(
...
unsafe extern "C" fn parse_userauth_request(
    ...
    mut expected_key: *const crate::sshkey::sshkey,
    mut userp: *mut *mut libc::c_char,
    mut sess_idp: *mut *mut crate::sshbuf::sshbuf,
    mut hostkeyp: *mut *mut crate::sshkey::sshkey,
) -> libc::c_int {
    ...
    let mut mkey: *mut crate::sshkey::sshkey = 0 as *mut crate::sshkey::sshkey;
    ...
    if !hostkeyp.is_null() {
        *hostkeyp = 0 as *mut crate::sshkey::sshkey;
    }
    b = sshbuf_fromb(msg);
    if b.is_null() {
        sshfatal(
    ...
    if !(r != 0 as libc::c_int) {
        if crate::sshbuf::sshbuf_len(sess_id) == 0 as libc::c_int as libc::c_ulong {
            ...
            if !(r != 0 as libc::c_int
                ...
                || {
                    r = crate::sshbuf_getput_basic::sshbuf_get_u8(b, &mut sig_follows);
                    r != 0 as libc::c_int
                }
                || {
                    r = crate::sshbuf_getput_basic::sshbuf_get_cstring(
                    ...
                    match current_block {
                        ...
                        _ => {
                            if crate::sshbuf::sshbuf_len(b) != 0 as libc::c_int as libc::c_ulong {
                                ...
                                if !hostkeyp.is_null() {
                                    *hostkeyp = hostkey;
                                    hostkey = 0 as *mut crate::sshkey::sshkey;
                                }
                            }
                        }
                    }
...
unsafe extern "C" fn process_sign_request2(mut e: *mut SocketEntry) {
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u32((*e).request, &mut flags);
            r != 0 as libc::c_int
        }
    {
        crate::log::sshlog(
...
unsafe extern "C" fn parse_dest_constraint_hop(
        ...
        }
    {
        ...
        loop {
            ...
            if r != 0 as libc::c_int || {
                r = crate::sshbuf_getput_basic::sshbuf_get_u8(b, &mut key_is_ca);
                r != 0 as libc::c_int
            } {
...
unsafe extern "C" fn parse_key_constraints(
    ...
    loop {
        ...
        r = crate::sshbuf_getput_basic::sshbuf_get_u8(m, &mut ctype);
        if r != 0 as libc::c_int {
            crate::log::sshlog(
                b"ssh-agent.c\0" as *const u8 as *const libc::c_char,
                (*::core::mem::transmute::<&[u8; 22], &[libc::c_char; 22]>(
            ...
            match ctype as libc::c_int {
                1 => {
                    if *deathp != 0 as libc::c_int as libc::c_long {
                        ...
                        r = crate::sshbuf_getput_basic::sshbuf_get_u32(m, &mut seconds);
                        if r != 0 as libc::c_int {
                            crate::log::sshlog(
                                b"ssh-agent.c\0" as *const u8 as *const libc::c_char,
                                (*::core::mem::transmute::<&[u8; 22], &[libc::c_char; 22]>(
                ...
                3 => {
                    if k.is_null() {
                        ...
                        r = crate::sshbuf_getput_basic::sshbuf_get_u32(m, &mut maxsign);
                        if r != 0 as libc::c_int {
                            crate::log::sshlog(
                                b"ssh-agent.c\0" as *const u8 as *const libc::c_char,
                                (*::core::mem::transmute::<&[u8; 22], &[libc::c_char; 22]>(
...
unsafe extern "C" fn no_identities(mut e: *mut SocketEntry) {
    ...
    if r != 0 as libc::c_int
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u32(msg, 0 as libc::c_int as u_int32_t);
            r != 0 as libc::c_int
        }
        || {
            r = sshbuf_put_stringb((*e).output, msg);
...
unsafe extern "C" fn process_ext_session_bind(mut e: *mut SocketEntry) -> libc::c_int {
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_u8((*e).request, &mut fwd);
            r != 0 as libc::c_int
        }
    {
        crate::log::sshlog(
...
unsafe extern "C" fn process_message(mut socknum: u_int) -> libc::c_int {
    ...
    if r != 0 as libc::c_int || {
        r = crate::sshbuf_getput_basic::sshbuf_get_u8((*e).request, &mut type_0);
        r != 0 as libc::c_int
    } {
