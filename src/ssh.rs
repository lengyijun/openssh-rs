...
extern "C" {
    ...
    fn sshkey_load_cert(_: *const libc::c_char, _: *mut *mut sshkey) -> libc::c_int;
...
pub static mut options: Options = Options {
    ...
    identity_keys: [0 as *const sshkey as *mut sshkey; 100],
    ...
    certificates: [0 as *const sshkey as *mut sshkey; 100],
    add_keys_to_agent: 0,
...
pub static mut sensitive_data: Sensitive = Sensitive {
    keys: 0 as *const *mut sshkey as *mut *mut sshkey,
    nkeys: 0,
};
...
unsafe fn main_0(mut ac: libc::c_int, mut av: *mut *mut libc::c_char) -> libc::c_int {
    ...
    while i < ac {
        ...
        *fresh1 = xstrdup(*av.offset(i as isize));
        i += 1;
        i;
    }
    ...
    *fresh2 = 0 as *mut libc::c_char;
        ...
        loop {
            ...
            match opt {
                ...
                81 => {
                    ...
                    {
                        cp = xstrdup(b"2\0" as *const u8 as *const libc::c_char);
                    } else if strcmp(
                        BSDoptarg,
                        b"compression\0" as *const u8 as *const libc::c_char,
                    ) == 0 as libc::c_int
                    {
                        cp = xstrdup(compression_alg_list(0 as libc::c_int));
                        len = strlen(cp);
                ...
                74 => {
                    ...
                    options.proxy_command = xstrdup(b"none\0" as *const u8 as *const libc::c_char);
                }
                116 => {
        ...
        && options.session_type != 0 as libc::c_int
    {
        sshfatal(
            ...
            SYSLOG_LEVEL_FATAL,
            0 as *const libc::c_char,
            b"Cannot fork into background without a command to execute.\0" as *const u8
                as *const libc::c_char,
        );
    }
    log_init(
    ...
    (*cinfo).keyalias = xstrdup(if !(options.host_key_alias).is_null() {
    ...
    match current_block {
        10800801741953260091 => {
            ...
            sensitive_data.keys = 0 as *mut *mut sshkey;
...
unsafe extern "C" fn ssh_init_forward_permissions(
    ...
    i = 0 as libc::c_int as u_int;
    while i < num_opens {
        arg = xstrdup(*opens.offset(i as isize));
        oarg = arg;
    ...
    if options.fork_after_authentication != 0 {
        if options.exit_on_forward_failure != 0 && options.num_remote_forwards > 0 as libc::c_int {
            crate::log::sshlog(
                ...
                SYSLOG_LEVEL_DEBUG1,
                0 as *const libc::c_char,
                b"deferring postauth fork until remote forward confirmation received\0" as *const u8
                    as *const libc::c_char,
            );
        } else {
            fork_postauth();
...
unsafe extern "C" fn load_public_identity_files(mut cinfo: *const ssh_conn_info) {
    ...
    let mut identity_keys: [*mut sshkey; 100] = [0 as *mut sshkey; 100];
    ...
    let mut certificates: [*mut sshkey; 100] = [0 as *mut sshkey; 100];
