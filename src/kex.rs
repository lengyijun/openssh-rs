...
pub unsafe extern "C" fn kex_input_ext_info(
    ...
    r = crate::packet::sshpkt_get_u32(ssh, &mut ninfo);
    if r != 0 as libc::c_int {
        return r;
    }
    ...
    while i < ninfo {
        ...
        r = crate::packet::sshpkt_get_string(ssh, &mut val, &mut vlen);
        if r != 0 as libc::c_int {
...
pub unsafe extern "C" fn kex_input_kexinit(
    ...
    i = 0 as libc::c_int as u_int;
    while i < 16 as libc::c_int as libc::c_uint {
        r = crate::packet::sshpkt_get_u8(ssh, 0 as *mut u_char);
        if r != 0 as libc::c_int {
            crate::log::sshlog(
                b"kex.c\0" as *const u8 as *const libc::c_char,
                (*::core::mem::transmute::<&[u8; 18], &[libc::c_char; 18]>(b"kex_input_kexinit\0"))
...
pub unsafe extern "C" fn kex_load_hostkey(
    mut ssh: *mut ssh,
    mut prvp: *mut *mut crate::sshkey::sshkey,
    mut pubp: *mut *mut crate::sshkey::sshkey,
) -> libc::c_int {
    let mut kex: *mut kex = (*ssh).kex;
    *pubp = 0 as *mut crate::sshkey::sshkey;
    *prvp = 0 as *mut crate::sshkey::sshkey;
...
pub unsafe extern "C" fn kex_verify_host_key(
    mut ssh: *mut ssh,
    mut server_host_key: *mut crate::sshkey::sshkey,
) -> libc::c_int {
    let mut kex: *mut kex = (*ssh).kex;
