...
extern "C" {
    ...
    fn ptimeout_deadline_ms(pt: *mut timespec, ms: libc::c_long);
    fn ptimeout_deadline_monotime(pt: *mut timespec, when: time_t);
    fn ptimeout_get_tsp(pt: *mut timespec) -> *mut timespec;
...
unsafe extern "C" fn server_input_hostkeys_prove(
    ...
    let mut key_pub: *mut sshkey = 0 as *mut sshkey;
    let mut key_prv: *mut sshkey = 0 as *mut sshkey;
    let mut r: libc::c_int = 0;
