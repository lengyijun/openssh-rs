...
extern "C" {
    ...
    fn get_hostkey_index(_: *mut sshkey, _: libc::c_int, _: *mut ssh) -> libc::c_int;
...
unsafe extern "C" fn monitor_read_log(mut pmonitor: *mut monitor) -> libc::c_int {
    ...
    if r != 0 as libc::c_int
        || {
            r = sshbuf_get_u32(logmsg, &mut forced);
            r != 0 as libc::c_int
        }
        || {
            r = sshbuf_get_cstring(logmsg, &mut msg, 0 as *mut size_t);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
pub unsafe extern "C" fn mm_answer_moduli(
    ...
    let mut max: u_int = 0;
    r = sshbuf_get_u32(m, &mut min);
    if r != 0 as libc::c_int
        || {
            r = sshbuf_get_u32(m, &mut want);
            r != 0 as libc::c_int
        }
        || {
            r = sshbuf_get_u32(m, &mut max);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
    ...
    if dh.is_null() {
        r = sshbuf_put_u8(m, 0 as libc::c_int as u_char);
        if r != 0 as libc::c_int {
            sshfatal(
                b"monitor.c\0" as *const u8 as *const libc::c_char,
                (*::core::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"mm_answer_moduli\0"))
...
pub unsafe extern "C" fn mm_answer_sign(
    ...
    r = sshbuf_get_u32(m, &mut keyid);
    if r != 0 as libc::c_int
        || {
            r = sshbuf_get_string(m, &mut p, &mut datlen);
            r != 0 as libc::c_int
        }
        || {
            r = sshbuf_get_cstring(m, &mut alg, &mut alglen);
            r != 0 as libc::c_int
        }
        || {
            r = sshbuf_get_u32(m, &mut compat);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
pub unsafe extern "C" fn mm_answer_pwnamallow(
    ...
    r = sshbuf_get_cstring(m, &mut (*authctxt).user, 0 as *mut size_t);
    if r != 0 as libc::c_int {
        sshfatal(
            b"monitor.c\0" as *const u8 as *const libc::c_char,
            (*::core::mem::transmute::<&[u8; 21], &[libc::c_char; 21]>(b"mm_answer_pwnamallow\0"))
...
pub unsafe extern "C" fn mm_answer_authserv(
    ...
    r = sshbuf_get_cstring(m, &mut (*authctxt).service, 0 as *mut size_t);
    if r != 0 as libc::c_int || {
        r = sshbuf_get_cstring(m, &mut (*authctxt).style, 0 as *mut size_t);
        r != 0 as libc::c_int
    } {
        sshfatal(
            b"monitor.c\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn mm_answer_authpassword(
    ...
    r = sshbuf_get_cstring(m, &mut passwd, &mut plen);
    if r != 0 as libc::c_int {
        sshfatal(
            b"monitor.c\0" as *const u8 as *const libc::c_char,
            (*::core::mem::transmute::<&[u8; 23], &[libc::c_char; 23]>(
...
pub unsafe extern "C" fn mm_answer_keyallowed(
    ...
    if r != 0 as libc::c_int
        || {
            r = sshbuf_get_cstring(m, &mut cuser, 0 as *mut size_t);
            r != 0 as libc::c_int
        }
        || {
        ...
        || {
            r = sshbuf_get_u32(m, &mut pubkey_auth_attempt);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
pub unsafe extern "C" fn mm_answer_keyverify(
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = sshbuf_get_cstring(m, &mut sigalg, 0 as *mut size_t);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
    ...
    if !sig_details.is_null() {
        r = sshbuf_put_u32(m, (*sig_details).sk_counter);
        if r != 0 as libc::c_int || {
            r = sshbuf_put_u8(m, (*sig_details).sk_flags);
            r != 0 as libc::c_int
        } {
            sshfatal(
                b"monitor.c\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn mm_answer_pty(
    ...
    if !s.is_null() {
        ...
        if !(res == 0 as libc::c_int) {
            ...
            r = sshbuf_put_u32(m, 1 as libc::c_int as u_int32_t);
            if r != 0 as libc::c_int || {
    ...
    r = sshbuf_put_u32(m, 0 as libc::c_int as u_int32_t);
    if r != 0 as libc::c_int {
        sshfatal(
            b"monitor.c\0" as *const u8 as *const libc::c_char,
            (*::core::mem::transmute::<&[u8; 14], &[libc::c_char; 14]>(b"mm_answer_pty\0"))
...
pub unsafe extern "C" fn mm_answer_pty_cleanup(
    ...
    r = sshbuf_get_cstring(m, &mut tty, 0 as *mut size_t);
    if r != 0 as libc::c_int {
        sshfatal(
            b"monitor.c\0" as *const u8 as *const libc::c_char,
            (*::core::mem::transmute::<&[u8; 22], &[libc::c_char; 22]>(b"mm_answer_pty_cleanup\0"))
