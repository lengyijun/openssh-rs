...
unsafe extern "C" fn revoked_certs_free(mut rc: *mut revoked_certs) {
    ...
    crate::sshkey::sshkey_free((*rc).ca_key);
}
...
unsafe extern "C" fn plain_key_blob(
    ...
    if sshkey_is_cert(kcopy) != 0 {
        ...
        if r != 0 as libc::c_int {
            crate::sshkey::sshkey_free(kcopy);
            return r;
        }
    }
...
unsafe extern "C" fn revoked_certs_generate(
    ...
    let mut sect: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    let mut bitmap: *mut bitmap = 0 as *mut bitmap;
    sect = crate::sshbuf::sshbuf_new();
    if sect.is_null() {
        return -(2 as libc::c_int);
    }
            ...
            if !(r != 0 as libc::c_int) {
                ...
                's_49: loop {
                            ...
                            || state == 0x21 as libc::c_int)
                    {
                        ...
                        r = crate::sshbuf_getput_basic::sshbuf_put_u8(buf, state as u_char);
                        if r != 0 as libc::c_int || {
...
unsafe extern "C" fn parse_revoked_certs(
    ...
    let mut subsect: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    ...
    libc::free(key_id as *mut libc::c_void);
    crate::sshkey::sshkey_free(ca_key);
    crate::sshbuf::sshbuf_free(subsect);
    return r;
}
unsafe extern "C" fn blob_section(
    mut sect: *mut crate::sshbuf::sshbuf,
    ...
    while crate::sshbuf::sshbuf_len(sect) > 0 as libc::c_int as libc::c_ulong {
        r = crate::sshbuf_getput_basic::sshbuf_get_string(sect, &mut rdata, &mut rlen);
        if r != 0 as libc::c_int {
            return r;
        }
...
pub unsafe extern "C" fn ssh_krl_from_blob(
    ...
    *krlp = 0 as *mut ssh_krl;
    ...
    i = 0 as libc::c_int as size_t;
    while i < nca_used {
        crate::sshkey::sshkey_free(*ca_used.offset(i as isize));
        i = i.wrapping_add(1);
        i;
    }
