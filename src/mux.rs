...
extern "C" {
    ...
    static mut command: *mut crate::sshbuf::sshbuf;
...
pub struct mux_session_confirm_ctx {
    ...
    pub cmd: *mut crate::sshbuf::sshbuf,
...
unsafe extern "C" fn mux_master_process_hello(
    ...
    mut _reply: *mut crate::sshbuf::sshbuf,
) -> libc::c_int {
    let mut ver: u_int = 0;
...
unsafe extern "C" fn reply_error(
    mut reply: *mut crate::sshbuf::sshbuf,
    mut type_0: u_int,
    mut rid: u_int,
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_cstring(reply, msg);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
        ...
        })
    {
        ...
        match current_block {
            ...
            _ => {
                ...
                (*cctx).cmd = crate::sshbuf::sshbuf_new();
                if ((*cctx).cmd).is_null() {
                    sshfatal(
                        b"mux.c\0" as *const u8 as *const libc::c_char,
                        (*::core::mem::transmute::<&[u8; 31], &[libc::c_char; 31]>(
                ...
                while i < 3 as libc::c_int as libc::c_uint {
                    ...
                    if new_fd[i as usize] == -(1 as libc::c_int) {
                        ...
                        crate::sshbuf::sshbuf_free((*cctx).cmd);
...
unsafe extern "C" fn mux_master_process_alive_check(
    ...
    mut rid: u_int,
    mut c: *mut Channel,
    mut _m: *mut crate::sshbuf::sshbuf,
    mut reply: *mut crate::sshbuf::sshbuf,
) -> libc::c_int {
    let mut r: libc::c_int = 0;
    crate::log::sshlog(
...
unsafe extern "C" fn mux_confirm_remote_forward(
    ...
    let mut out: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
...
unsafe extern "C" fn mux_stdio_confirm(
    ...
    let mut c: *mut Channel = 0 as *mut Channel;
    let mut cc: *mut Channel = 0 as *mut Channel;
    let mut reply: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    let mut r: libc::c_int = 0;
    if cctx.is_null() {
        sshfatal(
            b"mux.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn mux_master_read_cb(mut ssh: *mut ssh, mut c: *mut Channel) -> libc::c_int {
    let mut current_block: u64;
    let mut state: *mut mux_master_state = (*c).mux_ctx as *mut mux_master_state;
    let mut in_0: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    let mut out: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
...
unsafe extern "C" fn mux_client_write_packet(
    ...
    let mut queue: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    ...
    while have < need {
        if muxclient_terminate != 0 {
            crate::sshbuf::sshbuf_free(queue);
            *libc::__errno_location() = 4 as libc::c_int;
            return -(1 as libc::c_int);
        }
        len = write(
...
unsafe extern "C" fn mux_client_read_packet(
    ...
    if r != 0 as libc::c_int || {
        r = crate::sshbuf_getput_basic::sshbuf_put(m, ptr as *const libc::c_void, have);
        r != 0 as libc::c_int
    } {
        sshfatal(
            b"mux.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn mux_client_forward(
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_cstring(m, lhost);
            r != 0 as libc::c_int
        }
        || {
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_cstring(m, chost);
            r != 0 as libc::c_int
        }
        || {
    ...
    if options.num_send_env > 0 as libc::c_int as libc::c_uint && !environ.is_null() {
        ...
        while !(*environ.offset(i as isize)).is_null() {
            if !(env_permitted(*environ.offset(i as isize)) == 0) {
                r = crate::sshbuf_getput_basic::sshbuf_put_cstring(m, *environ.offset(i as isize));
                if r != 0 as libc::c_int {
                    sshfatal(
                        b"mux.c\0" as *const u8 as *const libc::c_char,
                        (*::core::mem::transmute::<&[u8; 27], &[libc::c_char; 27]>(
...
unsafe extern "C" fn mux_client_request_stdio_fwd(mut fd: libc::c_int) -> libc::c_int {
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_cstring(m, options.stdio_forward_host);
            r != 0 as libc::c_int
        }
        || {
            r = crate::sshbuf_getput_basic::sshbuf_put_u32(
