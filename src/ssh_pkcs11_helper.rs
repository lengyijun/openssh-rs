...
unsafe extern "C" fn lookup_key(mut k: *mut crate::sshkey::sshkey) -> *mut crate::sshkey::sshkey {
    let mut ki: *mut pkcs11_keyinfo = 0 as *mut pkcs11_keyinfo;
    ki = pkcs11_keylist.tqh_first;
    while !ki.is_null() {
        crate::log::sshlog(
...
unsafe extern "C" fn process_add() {
    ...
    if r != 0 as libc::c_int || {
        r = crate::sshbuf_getput_basic::sshbuf_get_cstring(iqueue, &mut pin, 0 as *mut size_t);
        r != 0 as libc::c_int
    } {
        sshfatal(
            b"ssh-pkcs11-helper.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn process_sign() {
    ...
    let mut msg: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    r = crate::sshbuf_getput_basic::sshbuf_get_string(iqueue, &mut blob, &mut blen);
    if r != 0 as libc::c_int
        || {
            r = crate::sshbuf_getput_basic::sshbuf_get_string(iqueue, &mut data, &mut dlen);
            r != 0 as libc::c_int
        }
        || {
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    out = 1 as libc::c_int;
    iqueue = crate::sshbuf::sshbuf_new();
    if iqueue.is_null() {
        sshfatal(
            b"ssh-pkcs11-helper.c\0" as *const u8 as *const libc::c_char,
    ...
    oqueue = crate::sshbuf::sshbuf_new();
    if oqueue.is_null() {
        sshfatal(
            b"ssh-pkcs11-helper.c\0" as *const u8 as *const libc::c_char,
            (*::core::mem::transmute::<&[u8; 5], &[libc::c_char; 5]>(b"main\0")).as_ptr(),
