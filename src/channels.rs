...
pub unsafe extern "C" fn channel_new(
    ...
    *fresh1 = crate::xmalloc::xcalloc(
    ...
    c = *fresh1;
    (*c).input = crate::sshbuf::sshbuf_new();
    if ((*c).input).is_null()
        || {
            (*c).output = crate::sshbuf::sshbuf_new();
            ((*c).output).is_null()
        }
        || {
            (*c).extended = crate::sshbuf::sshbuf_new();
            ((*c).extended).is_null()
        }
    {
        sshfatal(
    ...
    while i < (*pset).num_permitted_user {
        ...
        if !((*perm).downstream != c) {
            ...
            if r != 0 as libc::c_int
                ...
                || {
                    r = crate::packet::sshpkt_put_u32(ssh, (*perm).listen_port as u_int32_t);
                    r != 0 as libc::c_int
                }
                || {
...
pub unsafe extern "C" fn channel_not_very_much_buffered_data(mut ssh: *mut ssh) -> libc::c_int {
    ...
    while i < (*(*ssh).chanctxt).channels_alloc {
        ...
        if !(c.is_null() || (*c).type_0 != 4 as libc::c_int) {
            if crate::sshbuf::sshbuf_len((*c).output) > maxsize as libc::c_ulong {
                crate::log::sshlog(
                    b"channels.c\0" as *const u8 as *const libc::c_char,
                    ...
                    (*c).self_0,
                    crate::sshbuf::sshbuf_len((*c).output),
                    maxsize,
                );
                return 0 as libc::c_int;
            }
...
unsafe extern "C" fn channel_format_status(mut c: *const Channel) -> *mut libc::c_char {
    ...
    crate::xmalloc::xasprintf(
        ...
        (*c).remote_id,
        (*c).istate,
        crate::sshbuf::sshbuf_len((*c).input),
        (*c).ostate,
        crate::sshbuf::sshbuf_len((*c).output),
...
unsafe extern "C" fn open_preamble(
    ...
    let mut r: libc::c_int = 0;
    r = crate::packet::sshpkt_start(ssh, 90 as libc::c_int as u_char);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_put_cstring(ssh, type_0 as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
...
pub unsafe extern "C" fn channel_request_start(
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::packet::sshpkt_put_u8(ssh, wantconfirm as u_char);
            r != 0 as libc::c_int
        }
    {
        sshfatal(
...
pub unsafe extern "C" fn channel_set_fds(
    ...
    r = crate::packet::sshpkt_start(ssh, 93 as libc::c_int as u_char);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_put_u32(ssh, (*c).remote_id);
            r != 0 as libc::c_int
...
unsafe extern "C" fn channel_pre_open(mut ssh: *mut ssh, mut c: *mut Channel) {
    ...
    if (*c).istate == 0 as libc::c_int as libc::c_uint
        ...
        && crate::sshbuf::sshbuf_len((*c).input) < (*c).remote_window as libc::c_ulong
    ...
    {
        if crate::sshbuf::sshbuf_len((*c).output) > 0 as libc::c_int as libc::c_ulong {
            (*c).io_want |= 0x2 as libc::c_int as libc::c_uint;
            ...
            && (*c).ostate == 3 as libc::c_int as libc::c_uint)
    {
            ...
            && crate::sshbuf::sshbuf_len((*c).extended) > 0 as libc::c_int as libc::c_ulong
        {
            ...
            && crate::sshbuf::sshbuf_len((*c).extended) < (*c).remote_window as libc::c_ulong
        {
            (*c).io_want |= 0x4 as libc::c_int as libc::c_uint;
        }
    }
}
unsafe extern "C" fn x11_open_helper(
    mut ssh: *mut ssh,
...
unsafe extern "C" fn channel_decode_socks4(
    mut c: *mut Channel,
    mut input: *mut crate::sshbuf::sshbuf,
    mut output: *mut crate::sshbuf::sshbuf,
) -> libc::c_int {
    ...
    have = crate::sshbuf::sshbuf_len(input) as u_int;
    len = ::core::mem::size_of::<C2RustUnnamed_5>() as libc::c_ulong as u_int;
    if have < len {
        return 0 as libc::c_int;
    }
    p = crate::sshbuf::sshbuf_ptr(input);
...
unsafe extern "C" fn channel_pre_dynamic(mut ssh: *mut ssh, mut c: *mut Channel) {
    ...
    let mut ret: libc::c_int = 0;
    (*c).io_want = 0 as libc::c_int as u_int;
    have = crate::sshbuf::sshbuf_len((*c).input) as u_int;
    crate::log::sshlog(
        b"channels.c\0" as *const u8 as *const libc::c_char,
    ...
    p = crate::sshbuf::sshbuf_ptr((*c).input);
...
unsafe extern "C" fn channel_before_prepare_io_rdynamic(mut ssh: *mut ssh, mut c: *mut Channel) {
    ...
    let mut r: libc::c_int = 0;
    let mut ret: libc::c_int = 0;
    have = crate::sshbuf::sshbuf_len((*c).output) as u_int;
    crate::log::sshlog(
        b"channels.c\0" as *const u8 as *const libc::c_char,
    ...
    p = crate::sshbuf::sshbuf_ptr((*c).output);
    match *p.offset(0 as libc::c_int as isize) as libc::c_int {
        4 => {
    ...
    if ret < 0 as libc::c_int {
        ...
        len = crate::sshbuf::sshbuf_len((*c).input) as u_int;
        if len > 0 as libc::c_int as libc::c_uint && len < (*c).remote_window {
            r = crate::packet::sshpkt_start(ssh, 94 as libc::c_int as u_char);
            if r != 0 as libc::c_int
                || {
                    r = crate::packet::sshpkt_put_u32(ssh, (*c).remote_id);
                    r != 0 as libc::c_int
...
unsafe extern "C" fn channel_post_x11_listener(mut ssh: *mut ssh, mut c: *mut Channel) {
    ...
    r = crate::packet::sshpkt_put_cstring(ssh, remote_ipaddr as *const libc::c_void);
    if r != 0 as libc::c_int || {
        r = crate::packet::sshpkt_put_u32(ssh, remote_port as u_int32_t);
        r != 0 as libc::c_int
    } {
        sshfatal(
            b"channels.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn port_open_helper(
    ...
    if libc::strcmp(rtype, b"direct-tcpip\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        r = crate::packet::sshpkt_put_cstring(ssh, (*c).path as *const libc::c_void);
        if r != 0 as libc::c_int || {
            r = crate::packet::sshpkt_put_u32(ssh, (*c).host_port as u_int32_t);
            r != 0 as libc::c_int
        } {
            sshfatal(
                b"channels.c\0" as *const u8 as *const libc::c_char,
    ...
    ) == 0 as libc::c_int
    {
        ...
        r = crate::packet::sshpkt_put_cstring(ssh, (*c).path as *const libc::c_void);
        if r != 0 as libc::c_int || {
            r = crate::packet::sshpkt_put_u32(ssh, local_port as u_int32_t);
            r != 0 as libc::c_int
        } {
            sshfatal(
                b"channels.c\0" as *const u8 as *const libc::c_char,
    ...
    ) == 0 as libc::c_int
    {
        ...
        r = crate::packet::sshpkt_put_cstring(ssh, remote_ipaddr as *const libc::c_void);
        if r != 0 as libc::c_int || {
            r = crate::packet::sshpkt_put_u32(ssh, remote_port as u_int);
            r != 0 as libc::c_int
        } {
            sshfatal(
                b"channels.c\0" as *const u8 as *const libc::c_char,
    ...
    if sock == -(1 as libc::c_int) {
        ...
        if isopen != 0 {
            ...
            if r != 0 as libc::c_int
                ...
                || {
                    r = crate::packet::sshpkt_put_u32(ssh, 2 as libc::c_int as u_int32_t);
                    r != 0 as libc::c_int
                }
                || {
                    r = crate::packet::sshpkt_put_cstring(
                        ssh,
                        libc::strerror(err) as *const libc::c_void,
                    );
                    r != 0 as libc::c_int
                }
                || {
...
unsafe extern "C" fn channel_handle_rfd(mut ssh: *mut ssh, mut c: *mut Channel) -> libc::c_int {
    ...
    if pty_zeroread == 0 && ((*c).input_filter).is_none() && (*c).datagram == 0 {
        if (*c).type_0 == 4 as libc::c_int {
            have = crate::sshbuf::sshbuf_len((*c).input);
...
unsafe extern "C" fn channel_handle_wfd(mut ssh: *mut ssh, mut c: *mut Channel) -> libc::c_int {
    ...
    olen = crate::sshbuf::sshbuf_len((*c).output);
    ...
    match current_block {
        10379427723606251154 => {
            (*c).local_consumed = ((*c).local_consumed as libc::c_ulong)
                .wrapping_add(olen.wrapping_sub(crate::sshbuf::sshbuf_len((*c).output)))
                as u_int as u_int;
            return 1 as libc::c_int;
        }
        _ => {
...
unsafe extern "C" fn channel_handle_efd_write(
    ...
    if crate::sshbuf::sshbuf_len((*c).extended) == 0 as libc::c_int as libc::c_ulong {
        return 1 as libc::c_int;
    }
    len = write(
        (*c).efd,
        crate::sshbuf::sshbuf_ptr((*c).extended) as *const libc::c_void,
        crate::sshbuf::sshbuf_len((*c).extended),
    );
    crate::log::sshlog(
        b"channels.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn channel_check_window(mut ssh: *mut ssh, mut c: *mut Channel) -> libc::c_int {
        ...
        && (*c).local_consumed > 0 as libc::c_int as libc::c_uint
    {
        ...
        if r != 0 as libc::c_int
            ...
            || {
                r = crate::packet::sshpkt_put_u32(ssh, (*c).local_consumed);
                r != 0 as libc::c_int
            }
            || {
                r = crate::packet::sshpkt_send(ssh);
...
unsafe extern "C" fn read_mux(mut ssh: *mut ssh, mut c: *mut Channel, mut need: u_int) -> u_int {
    ...
    let mut r: libc::c_int = 0;
    if crate::sshbuf::sshbuf_len((*c).input) < need as libc::c_ulong {
        rlen = (need as libc::c_ulong).wrapping_sub(crate::sshbuf::sshbuf_len((*c).input)) as u_int;
        len = read(
            (*c).rfd,
            buf.as_mut_ptr() as *mut libc::c_void,
        ...
        if len == -(1 as libc::c_int) as libc::c_long
            && (*libc::__errno_location() == 4 as libc::c_int
                || *libc::__errno_location() == 11 as libc::c_int)
        {
            return crate::sshbuf::sshbuf_len((*c).input) as u_int;
        }
        if len <= 0 as libc::c_int as libc::c_long {
            crate::log::sshlog(
                b"channels.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn channel_post_mux_client_read(mut ssh: *mut ssh, mut c: *mut Channel) {
    ...
    need = (*(crate::sshbuf::sshbuf_ptr((*c).input)).offset(0 as libc::c_int as isize)
        as u_int32_t)
        << 24 as libc::c_int
        | (*(crate::sshbuf::sshbuf_ptr((*c).input)).offset(1 as libc::c_int as isize) as u_int32_t)
            << 16 as libc::c_int
        | (*(crate::sshbuf::sshbuf_ptr((*c).input)).offset(2 as libc::c_int as isize) as u_int32_t)
            << 8 as libc::c_int
        | *(crate::sshbuf::sshbuf_ptr((*c).input)).offset(3 as libc::c_int as isize) as u_int32_t;
...
unsafe extern "C" fn channel_post_mux_client_write(mut ssh: *mut ssh, mut c: *mut Channel) {
    ...
    len = write(
        (*c).wfd,
        crate::sshbuf::sshbuf_ptr((*c).output) as *const libc::c_void,
        crate::sshbuf::sshbuf_len((*c).output),
    );
    if len == -(1 as libc::c_int) as libc::c_long
        && (*libc::__errno_location() == 4 as libc::c_int
...
unsafe extern "C" fn channel_output_poll_input_open(mut ssh: *mut ssh, mut c: *mut Channel) {
    ...
    let mut r: libc::c_int = 0;
    len = crate::sshbuf::sshbuf_len((*c).input);
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = sshpkt_put_string(
                ssh,
                crate::sshbuf::sshbuf_ptr((*c).input) as *const libc::c_void,
                len,
            );
            r != 0 as libc::c_int
        }
...
unsafe extern "C" fn channel_output_poll_extended_read(mut ssh: *mut ssh, mut c: *mut Channel) {
    let mut len: size_t = 0;
    let mut r: libc::c_int = 0;
    len = crate::sshbuf::sshbuf_len((*c).extended);
    if len == 0 as libc::c_int as libc::c_ulong {
        return;
    }
    crate::log::sshlog(
    ...
    r = crate::packet::sshpkt_start(ssh, 95 as libc::c_int as u_char);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_put_u32(ssh, (*c).remote_id);
            r != 0 as libc::c_int
        ...
        || {
            r = crate::packet::sshpkt_put_u32(ssh, 1 as libc::c_int as u_int32_t);
            r != 0 as libc::c_int
        }
        || {
            r = sshpkt_put_string(
...
pub unsafe extern "C" fn channel_proxy_downstream(
    ...
    let mut current_block: u64;
    let mut c: *mut Channel = 0 as *mut Channel;
    let mut original: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    let mut modified: *mut crate::sshbuf::sshbuf = 0 as *mut crate::sshbuf::sshbuf;
    ...
    match current_block {
        11793792312832361944 => {
            if !modified.is_null() {
                r = crate::packet::sshpkt_start(ssh, type_0);
                if r != 0 as libc::c_int
                    || {
...
pub unsafe extern "C" fn channel_input_extended_data(
    ...
    r = crate::packet::sshpkt_get_u32(ssh, &mut tcode);
    if r != 0 as libc::c_int {
        crate::log::sshlog(
            b"channels.c\0" as *const u8 as *const libc::c_char,
            (*::core::mem::transmute::<&[u8; 28], &[libc::c_char; 28]>(
...
pub unsafe extern "C" fn channel_input_ieof(
    ...
    if (*c).force_drain != 0 && (*c).istate == 0 as libc::c_int as libc::c_uint {
        ...
        if crate::sshbuf::sshbuf_len((*c).input) == 0 as libc::c_int as libc::c_ulong {
            chan_ibuf_empty(ssh, c);
        }
    }
    return 0 as libc::c_int;
...
pub unsafe extern "C" fn channel_input_open_confirmation(
    ...
    r = crate::packet::sshpkt_get_u32(ssh, &mut (*c).remote_id);
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_get_u32(ssh, &mut remote_window);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_get_u32(ssh, &mut remote_maxpacket);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_get_end(ssh);
...
pub unsafe extern "C" fn channel_input_open_failure(
    ...
    r = crate::packet::sshpkt_get_u32(ssh, &mut reason);
    if r != 0 as libc::c_int {
        crate::log::sshlog(
            b"channels.c\0" as *const u8 as *const libc::c_char,
            (*::core::mem::transmute::<&[u8; 27], &[libc::c_char; 27]>(
    ...
    r = crate::packet::sshpkt_get_cstring(ssh, &mut msg, 0 as *mut size_t);
    if r != 0 as libc::c_int
        || {
...
pub unsafe extern "C" fn channel_input_window_adjust(
    ...
    r = crate::packet::sshpkt_get_u32(ssh, &mut adjust);
    if r != 0 as libc::c_int || {
        r = crate::packet::sshpkt_get_end(ssh);
        r != 0 as libc::c_int
    } {
...
pub unsafe extern "C" fn channel_input_status_confirm(
    ...
    if crate::packet::sshpkt_get_end(ssh) != 0 as libc::c_int {
        crate::packet::ssh_packet_disconnect(
            ssh,
    ...
    if !((*fwd).listen_path).is_null() {
        ...
        if r != 0 as libc::c_int
            ...
            || {
                r = crate::packet::sshpkt_put_cstring(
                    ssh,
                    (*fwd).listen_path as *const libc::c_void,
                );
                r != 0 as libc::c_int
            }
            || {
        ...
        if r != 0 as libc::c_int
            ...
            || {
                r = crate::packet::sshpkt_put_u32(ssh, (*fwd).listen_port as u_int32_t);
                r != 0 as libc::c_int
            }
            || {
                r = crate::packet::sshpkt_send(ssh);
...
unsafe extern "C" fn channel_request_rforward_cancel_tcpip(
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::packet::sshpkt_put_cstring(
                ssh,
                channel_rfwd_bind_host(host) as *const libc::c_void,
            );
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_put_u32(ssh, port as u_int32_t);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_send(ssh);
...
unsafe extern "C" fn channel_request_rforward_cancel_streamlocal(
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = crate::packet::sshpkt_put_cstring(ssh, path as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_send(ssh);
    ...
    while i < (*sc).channels_alloc {
            ...
            || (**((*sc).channels).offset(i as isize)).type_0 != 4 as libc::c_int)
        {
            ...
            ) == -(1 as libc::c_int))
            {
                ...
                r = crate::packet::sshpkt_put_u32(ssh, ws.ws_col as u_int);
                if r != 0 as libc::c_int
                    || {
                        r = crate::packet::sshpkt_put_u32(ssh, ws.ws_row as u_int);
                        r != 0 as libc::c_int
                    }
                    || {
                        r = crate::packet::sshpkt_put_u32(ssh, ws.ws_xpixel as u_int);
                        r != 0 as libc::c_int
                    }
                    || {
                        r = crate::packet::sshpkt_put_u32(ssh, ws.ws_ypixel as u_int);
                        r != 0 as libc::c_int
                    }
                    || {
                        r = crate::packet::sshpkt_send(ssh);
...
pub unsafe extern "C" fn x11_request_forwarding_with_spoofing(
    ...
    if r != 0 as libc::c_int
        || {
            r = crate::packet::sshpkt_put_cstring(ssh, proto as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_put_cstring(ssh, new_data as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_put_u32(ssh, screen_number as u_int32_t);
            r != 0 as libc::c_int
        }
        || {
            r = crate::packet::sshpkt_send(ssh);
