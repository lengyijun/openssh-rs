...
extern "C" {
    ...
    fn kex_prop2buf(_: *mut sshbuf, proposal: *mut *mut libc::c_char) -> libc::c_int;
...
pub unsafe extern "C" fn ssh_kex2(
    ...
    (*(*ssh).kex).verify_host_key = Some(
        verify_host_key_callback as unsafe extern "C" fn(*mut sshkey, *mut ssh) -> libc::c_int,
    );
    ...
    free(myproposal[PROPOSAL_KEX_ALGS as libc::c_int as usize] as *mut libc::c_void);
...
pub unsafe extern "C" fn ssh_userauth2(
    ...
    r = sshpkt_start(ssh, 5 as libc::c_int as u_char);
    if r != 0 as libc::c_int
        || {
...
unsafe extern "C" fn input_userauth_service_accept(
    ...
    if ssh_packet_remaining(ssh) > 0 as libc::c_int {
        ...
        r = sshpkt_get_cstring(ssh, &mut reply, 0 as *mut size_t);
        if r != 0 as libc::c_int {
...
pub unsafe extern "C" fn userauth(mut ssh: *mut ssh, mut authlist: *mut libc::c_char) {
    ...
    if authlist.is_null() {
        ...
        free((*authctxt).authlist as *mut libc::c_void);
...
unsafe extern "C" fn input_userauth_banner(
    ...
    r = sshpkt_get_cstring(ssh, &mut msg, &mut len);
    if !(r != 0 as libc::c_int || {
...
unsafe extern "C" fn input_userauth_failure(
    ...
    if !(sshpkt_get_cstring(ssh, &mut authlist, 0 as *mut size_t) != 0 as libc::c_int
        || sshpkt_get_u8(ssh, &mut partial) != 0 as libc::c_int
        || sshpkt_get_end(ssh) != 0 as libc::c_int)
    {
    ...
    free(authlist as *mut libc::c_void);
    return 0 as libc::c_int;
}
...
unsafe extern "C" fn userauth_none(mut ssh: *mut ssh) -> libc::c_int {
    let mut authctxt: *mut Authctxt = (*ssh).authctxt as *mut Authctxt;
    let mut r: libc::c_int = 0;
    r = sshpkt_start(ssh, 50 as libc::c_int as u_char);
    if r != 0 as libc::c_int
        || {
            r = sshpkt_put_cstring(ssh, (*authctxt).server_user as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
            r = sshpkt_put_cstring(ssh, (*authctxt).service as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
            r = sshpkt_put_cstring(ssh, (*(*authctxt).method).name as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
            r = sshpkt_send(ssh);
...
unsafe extern "C" fn userauth_passwd(mut ssh: *mut ssh) -> libc::c_int {
    ...
    if r != 0 as libc::c_int
        ...
        || {
            r = sshpkt_put_cstring(ssh, password as *const libc::c_void);
            r != 0 as libc::c_int
        }
        || {
...
unsafe extern "C" fn input_userauth_passwd_changereq(
    ...
    r = sshpkt_get_cstring(ssh, &mut info, 0 as *mut size_t);
    if !(r != 0 as libc::c_int || {
...
unsafe extern "C" fn key_sig_algorithm(
    ...
    free(oallowed as *mut libc::c_void);
    return alg;
}
    ...
    if alg.is_null() {
        ...
        if r != 0 as libc::c_int {
            ...
            if r != 0 as libc::c_int
                ...
                || {
                    r = sshpkt_put_u8(ssh, have_sig as u_char);
                    r != 0 as libc::c_int
                }
                || {
                    r = sshpkt_put_cstring(ssh, alg as *const libc::c_void);
                    r != 0 as libc::c_int
                }
                || {
...
unsafe extern "C" fn load_identity_file(mut id: *mut Identity) -> *mut sshkey {
...
unsafe extern "C" fn key_type_allowed_by_config(mut key: *mut sshkey) -> libc::c_int {
...
unsafe extern "C" fn pubkey_prepare(mut ssh: *mut ssh, mut authctxt: *mut Authctxt) {
    ...
    while !id.is_null() && {
        ...
        if !((*id).key).is_null() && key_type_allowed_by_config((*id).key) == 0 {
            ...
            *(*id).next.tqe_prev = (*id).next.tqe_next;
            sshkey_free((*id).key);
            free((*id).filename as *mut libc::c_void);
            memset(
                id as *mut libc::c_void,
                0 as libc::c_int,
                ::core::mem::size_of::<identity>() as libc::c_ulong,
...
unsafe extern "C" fn input_userauth_info_req(
    ...
    if !(r != 0 as libc::c_int
        || {
            r = sshpkt_get_cstring(ssh, &mut inst, 0 as *mut size_t);
            r != 0 as libc::c_int
        }
        || {
            r = sshpkt_get_cstring(ssh, &mut lang, 0 as *mut size_t);
        ...
        })
    {
        ...
        if !(r != 0 as libc::c_int) {
            r = sshpkt_start(ssh, 61 as libc::c_int as u_char);
            if !(r != 0 as libc::c_int || {
                ...
                loop {
                    ...
                    r = sshpkt_get_cstring(ssh, &mut prompt, 0 as *mut size_t);
                    if r != 0 as libc::c_int || {
                    ...
                    r = sshpkt_put_cstring(ssh, response as *const libc::c_void);
                    if r != 0 as libc::c_int {
                        current_block = 2494389617458814963;
                        break;
                    }
                    ...
                    free(prompt as *mut libc::c_void);
                    free(display_prompt as *mut libc::c_void);
...
unsafe extern "C" fn userauth_hostbased(mut ssh: *mut ssh) -> libc::c_int {
    ...
    if private.is_null() {
        free((*authctxt).oktypes as *mut libc::c_void);
        (*authctxt).ktypes = 0 as *mut libc::c_char;
        (*authctxt).oktypes = (*authctxt).ktypes;
        (*authctxt).active_ktype = 0 as *const libc::c_char;
        crate::log::sshlog(
                            ...
                            }
                        {
                            ...
                            if r != 0 as libc::c_int {
                                ...
                                if r != 0 as libc::c_int
                                    ...
                                    || {
                                        r = sshpkt_put_cstring(ssh, chost as *const libc::c_void);
                                        r != 0 as libc::c_int
                                    }
                                    || {
                                        r = sshpkt_put_cstring(
    ...
    free(keyblob as *mut libc::c_void);
...
unsafe extern "C" fn authmethod_get(mut authlist: *mut libc::c_char) -> *mut Authmethod {
    ...
    if supported.is_null() || strcmp(authlist, supported) != 0 as libc::c_int {
        ...
        free(supported as *mut libc::c_void);
